...
impl Overworld {
    pub fn new(world_model: WorldModel) -> Overworld {
        ...
        for y in 0..world_model.width {
            map_tiles.push(vec![]);
            for x in 0..world_model.height {
                map_tiles[y].push(Tile::from_usize(world_model.sprite_indexes[x][y]));
            }
        }
    ...
    //    sprite.texture = textures[0];
        ...
        for x in 0..world_model.width {
            for y in 0..world_model.height {
                ...
                sprite.pos.y = (y * 20) as f32  * -1.0f32 + 200.0f32;          
